...
var AirPlane = function () {
  ...
  // Use BufferGeometry instead of directly modifying vertices in new THREE.js versions
  const vertices = [
    ...
    // Back face: bottom left, bottom right, top left, top right
    -40,
    -25 - 10,
    25 + 20, // 4: Modified Y and Z
    40,
    -25 - 10,
    -25 - 20, // 5: Modified Y and Z
    -40,
    25 + 30,
    25 + 20, // 6: Modified Y and Z
    40,
    25 + 30,
    -25 - 20, // 7: Modified Y and Z
  ];
  ...
  geomCockpit = new THREE.BufferGeometry();
  geomCockpit.setAttribute(
    'position',
  ...
  const propVertices = [
    ...
    -10,
    -5 - 5,
    5 + 5, // 4: Modified Y and Z
    10,
    -5 - 5,
    -5 - 5, // 5: Modified Y and Z
    -10,
    5 + 5,
    5 + 5, // 6: Modified Y and Z
    10,
    5 + 5,
    -5 - 5, // 7: Modified Y and Z
  ];

  // Create propeller geometry
  var geomPropeller = new THREE.BufferGeometry();
  geomPropeller.setAttribute(
    'position',
    new THREE.Float32BufferAttribute(propVertices, 3)
  );
  geomPropeller.setIndex([...indices]); // Reuse previous indices
...
// Comment out original DOMContentLoaded binding, use from main.js to call init
